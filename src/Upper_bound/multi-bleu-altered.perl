...
$bleu[3] = $brevity_penalty * exp((my_log( $bleu[1] ) +
my_log( $bleu[2] ) + my_log( $bleu[3] ) ) / 3) ;

$bleu[2] = $brevity_penalty * exp((my_log( $bleu[1] ) +
my_log( $bleu[2] )) / 2) ;

$bleu[1] = $brevity_penalty * exp( my_log( $bleu[1] ) ) ;
...
#    $length_translation,
#    $length_reference;
open file_score,">>score_model.txt";
print file_score 100*$bleu, " ", 100*$bleu[3], " ", 100*$bleu[2], " ", 100*$bleu[1], "\n";
